...
import { Search, Filter, ArrowLeft, Phone, Mail, User } from 'lucide-react';
    ...
    const students: Student[] = [
        {
            ...
            rollNumber: "001",
            class_id: 3,
            idCardNumber: "93843844",
            admissionNumber: "432432423",
            dateOfAdmission: "2006-01-30T00:00:00Z",
            gender: "male",
            dob: "2000-01-21T00:00:00Z",
            phone: "+9112345678902",
            email: "john.doe@example.com",
            house: "parakkal house",
            ...
            bloodGroup: "A+",
            profilePic: "",
            remarks: "Excellent student with a keen interest in science",
            religion: "Hindu",
            caste: "General",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {students
                    .filter(student =>
                        ...
                        (student.admissionNumber && student.admissionNumber.includes(searchQuery))
                    )
                    .map(student => (
                        <div
                            key={student.id}
